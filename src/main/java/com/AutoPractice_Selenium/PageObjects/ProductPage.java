/**
Product page object represents the page containg parameters to choose a product (blouse)
before proceeding to the checkout form.
represents product color, quantity and button to add to cart and other webElements
**/
